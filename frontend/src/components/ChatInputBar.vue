...
<template>
    ...
    >
        <div class="w-full flex gap-2 items-center">
            ...
            <button
                type="submit"
                class="h-full btn px-2 rounded-lg flex items-center justify-center group hover:bg-gray-200 dark:hover:bg-zinc-700 transition-colors active:bg-gray-300 dark:active:bg-zinc-600 group"
            >
                <Send class="w-6 h-6" />
            </button>
        </div>

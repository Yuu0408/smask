                ...
                <section>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 py-5">
                        ...
                        <div>
                            <Label
                                class="py-1"
                                for="daily_activity_independence"
                                >{{
                                    $t(
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <Input
                                    v-if="
                                        form.has_past_medical_history === 'yes'
                                    "
                        ...
                        <div>
                            ...
                            >
                                ...
                                <Input
                                    v-if="
                                        form.has_current_medications === 'yes'
                                    "
                        ...
                        <div>
                            <Label
                                class="py-1"
                                for="has_family_medical_history"
                                >{{
                                    $t(
                            ...
                            >
                                ...
                                <Input
                                    v-if="
                                        form.has_family_medical_history ===
                                        'yes'
                                    "
    ...
    try {
        const payload = {
            ...
            social_information: {
                ...
                daily_activity_independence:
                    form.value.daily_activity_independence,

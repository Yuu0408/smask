...
- Follow the selection_plan target_condition and intent; do not switch targets unless it conflicts with asked_targets, pending_questions, or skip_questions from selection_plan.
...
- If selection_plan.skip_questions contains similar wording/targets, avoid re-asking; if nothing new is needed, acknowledge and keep the message short, leaning toward allow_finish_if_clear=true when safe.
